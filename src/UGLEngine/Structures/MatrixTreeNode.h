...
//This is a more-optimised but more complex (and not yet working) version of ScenegraphNode.
//TODO: Implement constructor/destructor (remember to set parent to null)
